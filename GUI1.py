...
class GUI:
    ...
    def show_knowledge_base(self, kb):
        ...
        self.chat_output.insert(ttk.END, kb_text + "\n")
    ...
    def init(self):
        ...
        self.chat_output = ttk.scrolledtext.ScrolledText(self.right_frame, wrap=tk.WORD, width=40, height=20)
        self.sidebar = Canvas(
            self.window,
            bg = '#171435',
            height = 950,
